...
class EmissionsForecastDTO(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            requested_at (datetime): For current requests, this value is the timestamp the request for forecast data was made.  For historical forecast requests, this value is the timestamp used to access the most   recently generated forecast as of that time.. [optional]  # noqa: E501
            ...
            optimal_data_points ([EmissionsDataDTO], none_type): The optimal forecasted data point within the 'forecastData' array.  Null if 'forecastData' array is empty.. [optional]  # noqa: E501
